...
import Profile from "../profile/profile"; // Adjust the import path as necessary
import "./navbar.css"
const Navbar = () => {
  ...
  return (
    <>
      <nav className="navbar flex justify-between items-center px-4 py-2 bg-gray-100 dark:bg-gray-800" style={{display: "flex"}} >
